...
arguments = {
    ...
    "alpha": UserSettableParameter("slider", "Alpha", 0.5, 0.0, 1.0, 0.01),
    "k_plus": UserSettableParameter("slider", "K+", 0.1, 0.0, 1.0, 0.01),
    "k_minus": UserSettableParameter("slider", "K-", 0.3, 0.0, 1.0, 0.01),
